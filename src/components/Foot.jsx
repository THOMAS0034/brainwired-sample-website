  ...
  <footer className="text-center text-lg-start text-white" style={{ backgroundColor: "#1c2331" }}>
    <section className="d-flex justify-content-between p-4" style={{ backgroundColor: "#6351ce" }}>
      ...
      <div>
        ...
        <a className='text-white-me-4'></a>
            <i className='text-white-me-4'>info@brainwired.in</i>
      ...
      <div className="container text-center text-md-start mt-5">
        <div className="row mt-3">
          <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            <img src="./imageset/logo.webp" alt="" className="img-fluid w-50"/>
          ...
          <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <hr className="mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px", backgroundColor: "#7c4dff", height: "2px" }} />
            <p><a href="#!" className="text-white">Westock</a></p>
            <p><a href="#!" className="text-white">Togo</a></p>
            <p><a href="#!" className="text-white">Rancher</a></p>
            <p><a href="#!" className="text-white">Buf</a></p>
          </div>
