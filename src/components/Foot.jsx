      ...
      <div className="container text-center text-md-start mt-5">
        <div className="row mt-3">
          ...
          <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            <h6 className="text-uppercase fw-bold foot-link-head">Useful links</h6>
            <hr className="mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px", backgroundColor: "#7c4dff", height: "2px" }} />
            <p><Link to="/career" className="text-grey foot-link">Career</Link></p>
            <p><Link to="/team" className="text-grey foot-link">Team</Link></p>
            <p><Link to="/aboutus" className="text-grey foot-link">About us</Link></p>
            <p><Link to="/blog" className="text-grey foot-link">Blog</Link></p>
          </div>

          <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            <h6 className="text-uppercase fw-bold foot-link-head">Contact</h6>
            <hr className="mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px", backgroundColor: "#7c4dff", height: "2px" }} />
