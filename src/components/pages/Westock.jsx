  ...
  return (
    <div className='westock-view'>
        ...
        <div className="westock-content">
            ...
            <h1 style={{width:'40%', margin:'auto',paddingBottom:'150px',paddingTop:'50px'}}>“ worlds most affordable “
livestock health monitoring system</h1>
            <p className='westock-content' data-aos='flip-up' data-aos-delay='200'>
              ...
              <h1 className='featurehead' data-aos='zoom-in' data-aos-delay='400' style={{color:'rgb(232, 61, 61)'}}>Heat Cycle Detection</h1>
              ...
              <h1 className='featurehead' data-aos='zoom-in' data-aos-delay='400' style={{color:'rgb(234, 144, 33)'}}>Body Temperature Monitoring</h1>
              ...
              <h1 className='featurehead' data-aos='zoom-in' data-aos-delay='400' style={{color:'rgb(39, 205, 69)'}}>Health Issue Prediction</h1>
              <p className='feature-content' data-aos='fade-right' data-aos-delay='500'>
              ...
              <h1 className='featurehead' data-aos='zoom-in' data-aos-delay='400' style={{color:'rgb(47, 192, 197)'}}>Movement & Activity Tracking</h1>
              <p className='feature-content' data-aos='fade-left' data-aos-delay='500'>
